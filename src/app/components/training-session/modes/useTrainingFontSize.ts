...
const FONT_SIZE_MAP: Record<TrainingFontSize, TrainingFontSizes> = {
  small: { sm: 14, base: 16, letter: 15, mask: 11, maskGridCol: 10, maskCharHeight: 16, level: 'small' },
  medium: { sm: 16, base: 18, letter: 17, mask: 12, maskGridCol: 11, maskCharHeight: 18, level: 'medium' },
  large: { sm: 18, base: 20, letter: 19, mask: 13, maskGridCol: 12, maskCharHeight: 20, level: 'large' },
};
