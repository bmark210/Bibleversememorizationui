    ...
    <div className="h-dvh flex flex-col overflow-hidden">
      ...
      >
        <nav
          ...
          className="flex justify-around border border-border-subtle bg-bg-overlay px-2.5 py-2.5 shadow-[var(--shadow-floating)] backdrop-blur-2xl narrow:rounded-t-[1.5rem] narrow:px-2 narrow:py-2"
>
          {navItems.map((item) => {
            const Icon = item.icon;
            const isActive = currentPage === item.id;
