...
type OnboardingStoreActions = {
  ...
  setTrackedVerseId: (id: string | null) => void;
  resetMockVerses: () => void;
  ...
  setStatusFilter: (filter: VerseListStatusFilter) => void;
  ensureCatalogFilter: () => void;
...
export const useOnboardingStore = create<OnboardingStore>((set, get) => ({
  ...
  startOnboarding: (source) => {
    ...
    set({
      ...
      source,
      mockVerses,
      trackedVerseId: ONBOARDING_PRIMARY_VERSE_ID,
      statusFilter: "catalog",
      isProgressDrawerOpen: false,
      progressTargetVerseId: null,
      isFiltersDrawerOpen: false,
  ...
  setTrackedVerseId: (id) => set({ trackedVerseId: id }),
  ...
  ensureCatalogFilter: () => set({ statusFilter: "catalog" }),
...
export function selectMockFilterLabel(state: OnboardingStore) {
  return getMockVerseFilterLabel(state.statusFilter);
}
