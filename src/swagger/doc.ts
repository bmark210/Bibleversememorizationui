    ...
    schemas: {
      ...
      UserDashboardStats: {
        ...
        properties: {
          ...
          learningStatusVerses: { type: "integer", minimum: 0 },
          ...
          xp: {
            type: "integer",
            minimum: 0,
            description: "Реактивный XP-рейтинг пользователя.",
          },
      ...
      UserLeaderboardEntry: {
        ...
        properties: {
          ...
          xp: {
            type: "integer",
            minimum: 0,
            description: "Реактивный XP-рейтинг участника.",
          },
      ...
      FriendPlayerListItem: {
        ...
        properties: {
          ...
          xp: {
            type: "integer",
            minimum: 0,
            description: "Реактивный XP-рейтинг игрока.",
          },
        },
      },
      ...
      DashboardFriendsActivitySummary: {
        ...
        properties: {
          ...
          avgXp: {
            type: "integer",
            minimum: 0,
            description: "Средний реактивный XP по друзьям.",
          },
        },
      },
