...
const DATASET_NAME = "ephesians-popular";
const EXPECTED_SEED_ENTRY_COUNT = 17;
...
const NORMALIZED_SEED_ENTRIES: readonly SeedEntry[] = [
  { reference: "Ефесянам 1:3-4", tags: ["blessing", "holiness", "identity"] },
  { reference: "Ефесянам 1:7-8", tags: ["grace", "forgiveness", "salvation"] },
  { reference: "Ефесянам 1:11-13", tags: ["truth", "salvation", "holy-spirit"] },
  { reference: "Ефесянам 1:22-23", tags: ["jesus-christ", "church", "authority"] },
  { reference: "Ефесянам 2:1-5", tags: ["salvation", "mercy", "love"] },
  { reference: "Ефесянам 2:8-10", tags: ["grace", "faith", "salvation", "service"] },
  { reference: "Ефесянам 2:19-22", tags: ["church", "unity", "identity"] },
  { reference: "Ефесянам 3:20-21", tags: ["power", "hope", "worship"] },
  { reference: "Ефесянам 4:1-4", tags: ["unity", "discipleship", "hope"] },
  { reference: "Ефесянам 4:11-15", tags: ["church", "service", "truth", "love"] },
  { reference: "Ефесянам 4:29-32", tags: ["truth", "forgiveness", "love", "holy-spirit"] },
  { reference: "Ефесянам 5:1-2", tags: ["love", "discipleship", "sacrifice"] },
  { reference: "Ефесянам 5:15-18", tags: ["wisdom", "holy-spirit", "holiness"] },
  { reference: "Ефесянам 5:22-25", tags: ["family", "love", "church"] },
  { reference: "Ефесянам 6:1-4", tags: ["family", "obedience", "discipleship"] },
  { reference: "Ефесянам 6:10-12", tags: ["power", "faith", "perseverance"] },
  { reference: "Ефесянам 6:17-18", tags: ["salvation", "prayer", "holy-spirit"] },
];
