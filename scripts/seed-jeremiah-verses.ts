...
const DATASET_NAME = "jeremiah-popular";
const EXPECTED_SEED_ENTRY_COUNT = 12;
...
// Набор собран по Top Verses: оставлены только действительно популярные и узнаваемые места,
// а соседние стихи объединены в отрывки до 5 стихов.
const NORMALIZED_SEED_ENTRIES: readonly SeedEntry[] = [
  { reference: "Иеремия 1:4-8", tags: ["identity", "mission", "encouragement"] },
  { reference: "Иеремия 2:3-4", tags: ["holiness", "identity", "truth"] },
  { reference: "Иеремия 6:16", tags: ["wisdom", "truth", "obedience"] },
  { reference: "Иеремия 9:23-24", tags: ["humility", "truth", "justice"] },
  { reference: "Иеремия 10:10-11", tags: ["truth", "worship", "warning"] },
  { reference: "Иеремия 15:16", tags: ["truth", "joy", "identity"] },
  { reference: "Иеремия 17:5-9", tags: ["faith", "warning", "truth"] },
  { reference: "Иеремия 23:5-6", tags: ["jesus-christ", "righteousness", "justice"] },
  { reference: "Иеремия 29:11-13", tags: ["hope", "prayer", "faith"] },
  { reference: "Иеремия 31:3", tags: ["love", "mercy", "hope"] },
  { reference: "Иеремия 31:31-34", tags: ["covenant", "forgiveness", "truth"] },
  { reference: "Иеремия 33:3", tags: ["prayer", "hope", "truth"] },
];
